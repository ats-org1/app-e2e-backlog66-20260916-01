...
#
# 使い方（ローカル）:
#   pwsh ./scripts/import.ps1 -SolutionName SampleSolution -EnvUrl https://<env>.crm7.dynamics.com -SettingsFile src/PP-Solutions/SampleSolution/settings/deployment-settings.stg.json
...
$srcDir = Join-Path $repoRoot "src/PP-Solutions/$SolutionName"
